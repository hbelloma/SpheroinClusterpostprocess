...
void MakeEfficiency( const char *f1 ="SOpp13TeV_MERGE_newbinsSOPCSO_PER114corr.root", const Char_t * outDir="Efficiencypt", TString suffix="png", const char *outfile="EfficiencyPerc10_Per11.root"){
