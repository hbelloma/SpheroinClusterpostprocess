...
void NormAbsSoSt( const Char_t * inFileName1="SOpp13TeV_MERGE_newbinsSOPCSOEQSt_Dat.root",  const Char_t * inFileName2="SOpp13TeV_MERGE_newbinsSOPCSOEQSt_Dat.root"){
...
TFile* outFile = new TFile("HistPercPP13000_dataLHC15f.root", "RECREATE");
