...
hmeanptppinel=(TH1D *)fppm->Get("hPtvsNm_inel");
...
hmeanptppinel->GetYaxis()->SetRangeUser(0.2,1.2);
...
legptm2->SetTextFont(42);
  ...
  legptm->SetHeader("pp 13 TeVs LHC15f pass2:");
  legptm2->SetHeader("Data LHC15f pass2 corrected with Pythia Per2011");
...
//      leg1->AddEntry(hmeanptmppEsBin[9],"Isot meas","P");
      ...
      Printf("else");
      hframe[index-1]->GetYaxis()->SetRangeUser(0.95,1.05);
